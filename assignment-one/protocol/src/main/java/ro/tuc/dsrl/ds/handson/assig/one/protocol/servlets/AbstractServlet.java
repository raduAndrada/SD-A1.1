 ...
 * @Since: Sep 1, 2015
 * @Description: Provides the abstract class for a Servlet which should handle a
 *               request.
 */
public abstract class AbstractServlet {
	...
	/**
	 * Execute the request; check the request method and call the appropriate method
	 * accordingly. In case the method is not implemented, an
	 * UnsupportedOperationException is thrown, in which case the NOT_ALLOWED status
	 * code is generated.
	 */
